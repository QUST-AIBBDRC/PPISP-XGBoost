...
cv_clf = GradientBoostingClassifier(n_estimators=500, learning_rate=0.01,
...
for train, test in skf.split(X,y): 
    ...
    print('GBDT:acc=%f,precision=%f,npv=%f,sensitivity=%f,specificity=%f,mcc=%f,f1=%f,roc_auc=%f'
